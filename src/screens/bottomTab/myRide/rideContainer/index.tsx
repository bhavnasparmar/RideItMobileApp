      ...
      <View>
        ...
        >
          ...
          >
            ...
            <View style={[styles.dashedLine, { borderColor: isDark ? appColors.darkBorder : colors.border }]} />
            <View style={{ flexDirection: viewRTLStyle }}>
              <Image
    ...
    <View style={styles.main}>
      {dataLoader ? (
        ...
        <View style={styles.noDataView}>
          <Image source={isDark ? Images.noRideDark : Images.noRide} style={styles.noRideImage} resizeMode="contain" />
