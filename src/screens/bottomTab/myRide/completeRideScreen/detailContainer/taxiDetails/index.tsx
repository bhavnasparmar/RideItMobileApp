    ...
    <View>
      {texiDetail?.rental_vehicle ? (
        <View >
          ...
          >
            <View style={{ flexDirection: viewRTLStyle, alignItems: 'center', paddingVertical: windowHeight(2), paddingHorizontal: windowWidth(15) }}>
              <View style={[styles.vehicleContainer1, { backgroundColor: bgFullStyle }]}>
                <Image
                  style={styles.imgContainer1}
                  source={{ uri: texiDetail?.rental_vehicle?.normal_image?.original_url }}
                />
              </View>
              <View style={{ flex: 1, marginStart: windowWidth(3) }}>
                ...
                <View style={[styles.platNumberView, { flexDirection: viewRTLStyle }]}>
                  <PlatNumber />
                  <Text
                    style={[
                      styles.vehicle_info,
          ...
          <View style={{ paddingHorizontal: windowWidth(19), marginTop: windowHeight(9) }}>
            ...
            <View style={{ borderBottomWidth: windowHeight(1), borderStyle: 'dashed', borderColor: isDark ? appColors.darkBorder : appColors.border, marginTop: windowHeight(9) }} />
          </View>
          <View style={[styles.tagContainer, { flexDirection: viewRTLStyle }]}>
            <View style={[{ flexDirection: viewRTLStyle }, {
              ...
              <Text style={styles.iconTitle}>{texiDetail?.rental_vehicle.vehicle_subtype}</Text>
            </View>
            <View style={[{ flexDirection: viewRTLStyle }, {
              backgroundColor: isDark ? appColors.bgDark : appColors.lightGray, padding: windowWidth(10),
              borderRadius: windowWidth(7),
              ...
              <Text style={styles.iconTitle}>{texiDetail?.rental_vehicle.fuel_type}</Text>
            </View>
            <View style={[{ flexDirection: viewRTLStyle }, {
              backgroundColor: isDark ? appColors.bgDark : appColors.lightGray, padding: windowWidth(10),
              borderRadius: windowWidth(7),
              ...
              <Text style={styles.iconTitle}>{texiDetail?.rental_vehicle.mileage}km/ltr</Text>
            </View>
            <View style={[{ flexDirection: viewRTLStyle }, {
              backgroundColor: isDark ? appColors.bgDark : appColors.lightGray, padding: windowWidth(10),
              borderRadius: windowWidth(7),
              ...
              <Text style={styles.iconTitle}>{texiDetail?.rental_vehicle.gear_type}</Text>
            </View>
            <View style={[{ flexDirection: viewRTLStyle }, {
              backgroundColor: isDark ? appColors.bgDark : appColors.lightGray, padding: windowWidth(10),
              borderRadius: windowWidth(7),
            ...
            <View style={[{ flexDirection: viewRTLStyle }, {
              ...
              <Speed />
              <Text style={styles.iconTitle}>{texiDetail?.rental_vehicle.vehicle_speed}/h</Text>
            </View>
            <View style={[{ flexDirection: viewRTLStyle }, {
              backgroundColor: isDark ? appColors.bgDark : appColors.lightGray, padding: windowWidth(10),
              borderRadius: windowWidth(7),
          ...
          <View style={{
            ...
            {texiDetail?.rental_vehicle?.interior?.map((item, index) => (
              <View key={index} style={{ flexDirection: viewRTLStyle, alignItems: 'center', marginBottom: windowHeight(5) }}>
                <Right />
                <Text style={{ color: '#797D83', marginHorizontal: windowWidth(12), fontFamily: appFonts.regular, fontSize: fontSizes.FONT18 }}>{item}</Text>
              </View>
            ))}
          </View>
        ...
        <View style={[styles.container, { paddingHorizontal: paddingHorizontal }, { backgroundColor: appColors.whiteColor, flexDirection: viewRTLStyle }]}>
          ...
          <View style={{ flexDirection: viewRTLStyle }}>
            <View style={styles.vehicleView}>
              <Text style={[external.mt_3, {
                textAlign: "center", fontFamily: appFonts.regular,
              ...
              <View style={[styles.platNumberView, { flexDirection: viewRTLStyle }]}>
                <PlatNumber />
                <Text style={[styles.vehicle_info, commonStyles.mediumTextBlack, external.as_end, { textAlign: textRTLStyle }]}>
