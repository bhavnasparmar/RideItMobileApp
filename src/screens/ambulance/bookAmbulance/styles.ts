...
const styles = StyleSheet.create({
    ...
    waitingImg: { height: windowHeight(100), width: windowHeight(100) },
    ambulanceApprovalText: { color: appColors.regularText, fontFamily: appFonts.medium, textAlign: 'center', marginVertical: windowHeight(10) },
    modelView:{ justifyContent: 'center', alignItems: 'center' },
